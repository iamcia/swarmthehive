...
<div class="container">
    <div class="sidebar">
        ...
        <?php if ($status == 'Approved'): ?>
            ...
            <div class="navigation-items1"><a href="tenant-index.php"><img src="/img/home.png" class="nav-icon" alt="Home Icon">Home</a></div>
            <div class="navigation-items1"><a href="ten-announcement.php"><img src="/img/announcement.png" class="nav-icon" alt="Announcements Icon">Announcements</a></div>
            <div class="navigation-items highlight"><a href="ten-communitymarket.php"><img src="/img/comm market.png" class="nav-icon" alt="Community Market Icon">Community Market</a></div>
            <div class="navigation-items1"><a href="ten-services.php"><img src="/img/services.png" class="nav-icon" alt="Services Icon">Services</a></div>
            <div class="navigation-items1"><a href="ten-paymentinfo.php"><img src="/img/payment info.png" class="nav-icon" alt="Payment Info Icon">Payment Info</a></div>
            <div class="navigation-items1"><a href="ten-safetyguidelines.php"><img src="/img/safe guidelines.png" class="nav-icon" alt="Safety Guidelines Icon">Safety Guidelines</a></div>
            <div class="navigation-items1"><a href="ten-communityfeedback.php"><img src="/img/comm feedback.png" class="nav-icon" alt="Community Feedback Icon">Community Feedback</a></div>
