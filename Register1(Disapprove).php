...
$_SESSION['ownerId'] = $ownerId;
    ...
    $sqlOwner = "UPDATE ownerinformation SET 
        Tower=?, Unit_Number=?, Owner_ID=?, Last_Name=?, First_Name=?, Middle_Name=?, Mobile_Number=?, Home_Number=?, 
    ...
    $tower, $unitNumber, $ownerId, $lastName, $firstName, $middleName, $mobileNumber, $homeNumber, 
...
function openChatbotPopup() {
        ...
        window.open("OwnerTenantChatbot5.php", "chatbotPopup", "width=500,height=500,top=300,left=300");
    }
</script>
</html>