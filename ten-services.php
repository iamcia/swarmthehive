...
if (isset($_SESSION['user_id'])) {
    $tenantId = $_SESSION['user_id']; // Using the session variable
    $status = '';

    // Fetch the owner's information with correct column names
    $sql = "SELECT t.ID as user_db_id, t.Tenant_ID, t.Status 
            FROM tenantinformation t 
            WHERE t.Tenant_ID = ?";

    if ($stmt = $conn->prepare($sql)) {
        $stmt->bind_param("s", $tenantId); // Bind the tenantId parameter
        $stmt->execute();
        ...
        if ($userData) {
            ...
            $_SESSION['tenant_id'] = $tenant_id; // Correct the variable name here
        } else {
            echo "Error: No user found for the provided Tenant_ID.";
        }
        $stmt->close();
    } else {
        echo "Error: Query failed to prepare.";
    }
            ...
            <div class="mb-6">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 transition-all duration-300 hover:shadow-card-hover border-t-4 border-primary-500">
                        ...
                        <a href="MoveInNotice2.php" class="w-full flex items-center justify-center px-4 py-2 bg-primary-100 hover:bg-primary-200 text-primary-700 rounded-lg transition-colors">
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 transition-all duration-300 hover:shadow-card-hover border-t-4 border-red-500">
                        ...
                        <a href="MoveOutNotice2.php" class="w-full flex items-center justify-center px-4 py-2 bg-red-100 hover:bg-red-200 text-red-700 rounded-lg transition-colors">
                            <span>Submit Notice</span>
                            <i class='bx bx-right-arrow-alt ml-2'></i>
                        </a>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 transition-all duration-300 hover:shadow-card-hover border-t-4 border-blue-500">
                        ...
                        <a href="GuestInOutForm2.php" class="w-full flex items-center justify-center px-4 py-2 bg-blue-100 hover:bg-blue-200 text-blue-700 rounded-lg transition-colors">
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 transition-all duration-300 hover:shadow-card-hover border-t-4 border-green-500">
                        ...
                        <a href="Gatepass2.php" class="w-full flex items-center justify-center px-4 py-2 bg-green-100 hover:bg-green-200 text-green-700 rounded-lg transition-colors">
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 transition-all duration-300 hover:shadow-card-hover border-t-4 border-purple-500">
                        ...
                        <a href="PetRegistration2.php" class="w-full flex items-center justify-center px-4 py-2 bg-purple-100 hover:bg-purple-200 text-purple-700 rounded-lg transition-colors">
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 transition-all duration-300 hover:shadow-card-hover border-t-4 border-orange-500">
                        ...
                        <a href="VisitorPass2.php" class="w-full flex items-center justify-center px-4 py-2 bg-orange-100 hover:bg-orange-200 text-orange-700 rounded-lg transition-colors">
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 transition-all duration-300 hover:shadow-card-hover border-t-4 border-yellow-500">
                        ...
                        <a href="WorkPermit2.php" class="w-full flex items-center justify-center px-4 py-2 bg-yellow-100 hover:bg-yellow-200 text-yellow-700 rounded-lg transition-colors">
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 transition-all duration-300 hover:shadow-card-hover border-t-4 border-teal-500">
                        ...
                        <p class="text-gray-600 mb-4">Book community amenities for private events or personal use.</p>
                            <a href="TenantReservation.php" class="w-full flex items-center justify-center px-4 py-2 bg-teal-100 hover:bg-teal-200 text-teal-700 rounded-lg transition-colors">
                    ...
                    <div class="bg-white rounded-xl shadow-card p-6 transition-all duration-300 hover:shadow-card-hover border-t-4 border-cyan-500">
                        ...
                        <a href="ReservePool2.php" class="w-full flex items-center justify-center px-4 py-2 bg-cyan-100 hover:bg-cyan-200 text-cyan-700 rounded-lg transition-colors">
