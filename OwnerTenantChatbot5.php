...
<body>
    <div class="main-content">
        ...
        <div id="prompts">
            <div class="prompt" onclick="sendPrompt('owner1')">When I log in why am I being redirected here?</div>
            <div class="prompt" onclick="sendPrompt('owner2')">How to update RIS even though my account status is verified</div>
        </div>
    </div>

    <script>
        const responses = {
            'owner1': 'Your account is been disapproved by the admin. You might submitted wrong information or file. You can update your information here',
            'owner2': 'Contact admin to give you the link for this form',
        };
