...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($user_id !== null) {
        ...
        try {
            ...
            $stmt = $conn->prepare("INSERT INTO gatepass (Resident_Code, User_Type, Date, Time, Bearer, Authorization, Items, Status, user_id) VALUES (?, ?, ?, ?, ?, ?, ?, 'Pending', ?)");
            ...
            if ($result1 && $result2) {
                ...
                echo "<script>
                    ...
                    window.location.href = 'Gatepass2.php';
                </script>";
                exit;
            } else {
...
<body class="bg-gray-50 min-h-screen">
    <div class="max-w-4xl mx-auto px-4 py-10">
        ...
        <!-- Form Section -->
        <form class="space-y-8" method="POST" action="Gatepass2.php" enctype="multipart/form-data">
